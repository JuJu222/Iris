...
def init():
    ...
    open_eye_cascPath = cv2.data.haarcascades + 'haarcascade_eye_tree_eyeglasses.xml'
    left_eye_cascPath = cv2.data.haarcascades + 'haarcascade_lefteye_2splits.xml'
    right_eye_cascPath = cv2.data.haarcascades + 'haarcascade_righteye_2splits.xml'
    dataset = 'faces'
